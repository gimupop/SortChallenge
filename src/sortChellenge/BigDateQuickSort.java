 ...
 * <p>
 * 大量データのソート処理（クイックサーチ版）
 */
public class BigDateQuickSort {
    private static final String INPUT_FILE_PATH = "C:\\work\\challenge\\sort_median.txt";
    //    private static final String INPUT_FILE_PATH = "/home/yanagawa/BigDateSortChallenge/date/sort_median.txt";
    private static final String OUTPUT_FILE_PATH = "C:\\work\\challenge\\sorted_file_test_quick.txt";
    //    private static final String OUTPUT_FILE_PATH = "/home/yanagawa/BigDateSortChallenge/date/output.txt";
    private static final int SORT_DATE_COUNT = 100000000;
    private static final int THRESHOLD_VALUE = 500000000;
    ...
    public static void main(String[] args) {
        ...
        while (processCount < SORT_DATE_COUNT) {
            ArrayList sortTarget = makeSortTarget(thresholdValue);
     ...
     * @return result ソート対象
     */
    public static ArrayList<Integer> makeSortTarget(int thresholdValue) {
        FileReader fr = null;
        ...
        try {
            String counter;
            long start = System.currentTimeMillis();
            fr = new FileReader(INPUT_FILE_PATH);
     ...
     */
    public static void fileWriter(int[] writingDate) {
        ...
        try {
            if (checkBeforeWriteFile(file)) {
                PrintWriter pw;
                pw = new PrintWriter(new BufferedWriter(new FileWriter(OUTPUT_FILE_PATH, true)));
